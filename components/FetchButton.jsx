...
export default function FetchButton({ defaultLabel = 'Rafraîchir', onFetch, initialCooldown = 0, refreshDelay = 60 }) {
  const [loading, setLoading] = useState(false);
  const [cooldown, setCooldown] = useState(initialCooldown > refreshDelay ? 0 : initialCooldown); // secondes restantes
