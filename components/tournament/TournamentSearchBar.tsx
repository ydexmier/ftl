...
export function TournamentSearchBar() {
  ...
  const search = useCallback(async (q: string) => {
    if (q.length < 1) { setResponse(null); return; }
    setLoading(true);
    try {
  ...
  useEffect(() => {
    ...
    if (query.length < 1) { setResponse(null); return; }
    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        ...
        <input
          ...
          placeholder="Rechercher un tournoi par nom ou ID…"
          ...
          {response!.results.length > 0 ? (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Rechercher sur Ravensburger et lier à votre compte</p>
              </div>
            </button>
          ) : (
