    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground tracking-tight">FTL</h1>
        ...
        <div className="bg-card border border-border rounded-xl p-8 shadow-xl">
          ...
          {error && <div className="mb-4"><Alert severity="error">{error}</Alert></div>}
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <Input label="Identifiant" value={username} onChange={e => setUsername(e.target.value)} autoComplete="username" required />
            ...
            <Button type="submit" variant="default" className="w-full mt-2" loading={loading}>Se connecter</Button>
          </form>
        </div>
      </div>
    </div>
